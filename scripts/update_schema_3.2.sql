...
CREATE TABLE iseq_product_components (
  `id_iseq_pr_components_tmp` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT \
    COMMENT 'Internal to this database id, value can change',
  `id_iseq_pr_tmp` INT(10) UNSIGNED NOT NULL \
    COMMENT 'iseq_product_metrics table row id for the product',
  `id_iseq_pr_component_tmp` INT(10) UNSIGNED NOT NULL \
