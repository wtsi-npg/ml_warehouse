...
ADD COLUMN `rna_norm_5_prime_coverage` FLOAT(12,10) NULL
DEFAULT NULL 
...
ADD COLUMN `rna_intronic_rate` FLOAT(12,10) NULL
DEFAULT NULL 
COMMENT 'Intronic rate is the fraction mapping within introns'
AFTER `rna_norm_5_prime_coverage`,

ADD COLUMN `rna_transcripts_detected` INT(10) NULL
DEFAULT NULL 
