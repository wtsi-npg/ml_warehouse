...
=head2 library_type
  ...
  data_type: 'enum'
  extra: {list => ['Chromium genome','Haplotagging','Hi-C','Hi-C - Arima v1','Hi-C - Arima v2','Hi-C - Dovetail','Hi-C - Omni-C','Hi-C - Qiagen','PacBio - CLR','PacBio - HiFi','ONT','RNA PolyA','RNA-seq dUTP eukaryotic','Standard','unknown','HiSeqX PCR free','PacBio - HiFi (ULI)','PacBio - IsoSeq','ATAC-seq','PacBio - HiFi (PiMmS)','PacBio - HiFi (Ampli-Fi)']}
  is_nullable: 1
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1rKdu4ZK2u6c9bvwXEIkwQ
