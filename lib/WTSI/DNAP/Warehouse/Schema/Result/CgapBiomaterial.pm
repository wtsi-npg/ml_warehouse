...
=head2 C<biomaterial_barcode>

=over 4

=item * L</biomaterial_barcode>

=back

=cut

__PACKAGE__->add_unique_constraint('biomaterial_barcode', ['biomaterial_barcode']);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:p2Apz8Qc2V3xUJmk6Ki/8A
